...
export interface Evento {
  ...
  lugar?: string | null; // e.g. "El Huevo", "Terraza Bellavista", "Subida Ecuador #182"
  ciudad: string; // "Valparaíso", "Viña del Mar", "Reñaca", "Quilpué", "Villa Alemana", "Concón"
  sector?: string | null; // "Subida Ecuador", "Cerro Alegre", "Puerto", "Reñaca", "Centro"
  precio: number; // CLP, 0 = gratis
  precio_texto?: string | null; // e.g. "Gratis en lista hasta 00:30, luego $5.000 c/cover"
  categoria: Categoria;
  imagen_url?: string | null;
  fuente: FuenteEvento;
  fuente_url?: string | null;
  organizador?: string | null; // e.g. "@elhuevovalpo", "@feuv.oficial"
...
export const HOTSPOTS_COORDENADAS: Record<string, { lat: number; lng: number; descripcion: string }> = {
  ...
  'Muelle Barón, Valparaíso': { lat: -33.0401, lng: -71.6046, descripcion: 'Galpones, tocatas masivas frente al mar' },
  'Barrio Puerto / Sotomayor': { lat: -33.0384, lng: -71.6288, descripcion: 'Fiestas under, cantinas clásicas y post-punk' },
  'Cerro Concepción & Alegre': { lat: -33.0435, lng: -71.6276, descripcion: 'Bares boutique, acústicos y terrazas con vista' },
  ...
  'Trotamundos / Quilpué Centro': { lat: -33.0456, lng: -71.4429, descripcion: 'Trotamundos Terraza, tocatas nacionales y fiesta' },
};
